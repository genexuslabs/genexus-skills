...
- [Methods](#methods)
  ...
  - [`openRowActions`](#openrowactionscell-htmlelement--promisevoid)
  - [`openRowContext`](#openrowcontextclientx-number-clienty-number--promisevoid)
  - [`openRowHover`](#openrowhoverrow-htmlelement--promisevoid)

...
- [Events](#events)
- [Methods](#methods)
  - [`cellEnsureVisible`](#cellensurevisiblecellid-string--promisevoid)
  - [`collapseRow`](#collapserowrowid-string--promisevoid)
  - [`expandRow`](#expandrowrowid-string--promisevoid)
  - [`getFocusedCell`](#getfocusedcell--promise-cellid-string-rowid-string-columnid-string-)
  - [`getFocusedRow`](#getfocusedrow--promisestring)
  - [`getHoveredRow`](#gethoveredrow--promisestring)
  - [`getMarkedRows`](#getmarkedrows--promisestring)
  - [`getNextCell`](#getnextcell--promise-cellid-string-rowid-string-columnid-string-)
  - [`getNextRow`](#getnextrow--promisestring--void)
  - [`getPreviousCell`](#getpreviouscell--promise-cellid-string-rowid-string-columnid-string-)
  - [`getPreviousRow`](#getpreviousrow--promisestring--void)
  - [`getSelectedCell`](#getselectedcell--promise-cellid-string-rowid-string-columnid-string-)
  - [`getSelectedRows`](#getselectedrows--promisestring)
  - [`markAllRows`](#markallrowsmarked-boolean--promisevoid)
  - [`markRow`](#markrowrowid-string-marked-boolean--promisevoid)
  - [`rowEnsureVisible`](#rowensurevisiblerowid-string--promisevoid)
  - [`selectAllRows`](#selectallrowsselected-boolean--promisevoid)
  - [`selectCell`](#selectcellcellid-string-rowid-string-columnid-string-selected-boolean--promisevoid)
  - [`selectRow`](#selectrowrowid-string-selected-boolean--promisevoid)
  - [`syncRowState`](#syncrowstateel-htmlelement--promisevoid)
- [Slots](#slots)
...
### Depends on
 ...
 - [ch-tabular-grid-settings](../ch-tabular-grid-settings/README.md)
 - [ch-tabular-grid-settings-columns](../ch-tabular-grid-settings-columns/README.md)

# Mercury installation by framework

Install Chameleon and Mercury first:

```bash
npm i @genexus/chameleon-controls-library @genexus/mercury
```

Then follow the guide for your framework (all paths are local to this skill):

- [Installation for React (with Vite)](installation-for-react.md)
- [Installation for Angular](installation-for-angular.md)
